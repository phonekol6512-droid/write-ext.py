...
"""
        ...
        if r2.status_code == 200 and '"responseStatus":"OK"' in r2.text:
            ...
            msg = f"השלוחה {clean_ext} הוגדרה. מהירות: {speed_label}. ספירת העומר: {omer_status}. ועידה: {conf_status}. סולמית: {hash_status}. כוכבית: {star_status}"
            return ym_say_and_go_back(msg)  # משתמש ב-TTS, לא מנתק
        else:
